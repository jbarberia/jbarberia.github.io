...
The solvers and parameters selected in each library were described, detailing the results obtained for each 
solved case and for each proposed alternative. Based on this, resolution times and deviations from the PGLIB 
